...
from agents import researcher_node, document_processor_node, synthesizer_node, query_refiner_node
...
# --- PHASE 1: Add Query Refiner Node ---
...
# --- PHASE 1: Route START to QueryRefiner ---
# workflow.add_edge(START, "Researcher")
workflow.add_edge(START, "QueryRefiner")
workflow.add_edge("QueryRefiner", "Researcher")
# --------------------------------------------
